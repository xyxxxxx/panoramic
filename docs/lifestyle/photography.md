...
1. **曝光合成**：拍摄多张不同曝光区间的照片覆盖场景的动态范围，然后后期进行合成：

    ![](https://s2.loli.net/2024/07/21/c4IyGoZjaXxef3M.png)

    常见的操作是拍摄一张向左曝光，拍摄一张向右曝光，然后在 PS 中进行 HDR 合成。

2. **宁欠勿过**：向右曝光，但目的是让亮部区域保留更多细节，后期提亮暗部区域。需要相机有较高的宽容度。与曝光合成相比，宁欠勿过更方便，但得到的画质稍差。可以连拍并在后期进行平均值堆栈以得到更好的画质。
...
* 软硬：硬光表示光比大，明暗过渡为突变；柔光表示光比小，明暗过渡为渐变。 
